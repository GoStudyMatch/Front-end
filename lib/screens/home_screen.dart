          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    context.push('/study/search?filter=my');
                  },
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    context.push('/study/search?filter=recommended');
                  },
                  child: const Text('전체보기'),
                ),
              ],
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    context.push('/study/detail/${index + 6}');
                  },
                  child: Container(
                    width: 160,
                    margin: const EdgeInsets.only(right: 12),
